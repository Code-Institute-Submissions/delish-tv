...
While these shows can give us a sense of what it is like to visit a particular business and allows viewers to witness hosts delighting at the food on offer, it can be challenging to find more information about the various settings that they explore. If a viewer wishes to find more information, they must become proficient with Google and be willing to peruse article after article that may provide them with some tidbits of information.

The purpose of this site is to connect users with the restaurants and businesses featured in Netflix Original culinary shows and provide them with relevant information should they wish to experience it for themselves rather than live through an on-screen host. This adds another dimension to the traditional methods of sourcing more information about a restaurant, as convenient episode links enable users to see a restaurant's menu or ambience brought to life rather than judging a location on still photos, menus, and user reviews of varying quality and trustworthiness.  

## Scope 
The site's main target is fans of Netflix Original culinary shows. However, the crossover of food and bringing these food experiences to life also makes it useful for people travelling to or living in an area in which a local restaurant has been featured in an episode. As a business, we have our own distinct goals, as reflected by the following user stories.
